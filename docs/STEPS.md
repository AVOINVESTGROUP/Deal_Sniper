...
- Локальный gate успешен: Ruff, mypy и 71 pytest. Код и Hosting ещё не заявляются как развёрнутые в production: требуется immutable build/deploy и живой smoke.
