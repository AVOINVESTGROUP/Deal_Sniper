...
> `0.11R`, стабилизационных релизов `0.11A–0.11C`, миграции `0.11M`, baseline-релиза
> `0.11D` и официального пилота `0.11P` из
...
`0.11A–0.11C`, миграции `0.11M`, baseline `0.11D` и пилота `0.11P`.
