...
> `0.11R`, стабилизационных релизов `0.11A–0.11C`, migration implementation `0.11MI`, immutable candidate `0.11RC`,
...
`0.11A–0.11C`, migration implementation `0.11MI`, immutable candidate `0.11RC`, миграции `0.11M`, baseline `0.11D` и пилота `0.11P`.
