...
> находится в draft PR #1 и требует `0.11-STOP`, стабилизационных релизов `0.11A–0.11C`,
> миграции `0.11M` и baseline-релиза `0.11D` из
...
До выполнения `0.11-STOP/0.11A` не следует использовать `/scan`, `/deals`, `/watchlist`
...
использоваться для production-публикации до `0.11-STOP`, `0.11A–0.11C`, миграции
`0.11M`, baseline `0.11D` и нового пилота.
