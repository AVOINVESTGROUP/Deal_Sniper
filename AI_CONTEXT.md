...
- Канонический следующий порядок: `0.11-STOP` после отдельного подтверждения владельца, затем `0.11A`, `0.11B`, `0.11C`, миграция `0.11M`, baseline `0.11D` и новый официальный пилот.
...
- До Free/Pro, поиска и панели обязательны `0.11-STOP`, `0.11A–0.11C`, миграция `0.11M`, baseline `0.11D` и новый официальный пилот.
